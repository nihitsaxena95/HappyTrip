...
<br>
 <h1>Edit Schedule Information</h1>  
       <form:form name = "s1" method="get" action="/HappyTrip/scheduleupdatesave.html">    
        <table >    
        <tr>  
        <td></td>    
         <td><form:hidden  path="dep" /></td>  
         </tr>
         <tr>  
        <td></td>    
         <td><form:hidden  path="arr" /></td>  
         </tr>   
         <tr>    
         ...
         <form:option value="${emp.getAirline_code() }">${emp.getAirline_code() }(${emp.getAirline_name() })</form:option>  
          ...
          <tr>
          <td></td>
          <td><form:input path="flightdate" id="datepicker-13" /></td>
          </tr>
         <tr>    
          <td> </td>    
